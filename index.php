...
<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css'>
    <link rel="stylesheet" href="/portfolio/port.css" />
  </head>
  <body>
      ...
      <nav class="navbar">
        <div class="max-width">
          <div class="logo"><a href="#"><span>CNSTECH</span><span>.com</span></a></div>
          <ul class="menu">
      ...
      <section class="home" id="home">
        <div class="max-width">
          <div class="home-content">
            ...
            <div class="text-2">Philip Meliga</div>
            <div class="text-3">And I'm a <span class="typing"></span></div>
            <a href="mailto: philipmeliga01@gmail.com">Let's work together</a>
          </div>
        </div>
      </section>
        ...
        <div class="max-width">
          ...
          <div class="about-content">
            <div class="column left">
              <img src="/portfolio/philip.jpg" alt="Profile Image 626x626">
            </div>
            <div class="column right">
              <div class="text">I'm Philip and I'm a <span class="typing-2"></span></div>
      ...
      <section class="projects" id="projects">
        <div class="max-width">
          ...
          <div class="carousel owl-carousel">
            <div class="card">
              <div class="box">
                <img src="/portfolio/e-commerce.jpg" alt="">
                <div class="text">Ecommerce website</div>
                <p>An online platform for buying and selling products, featuring product listings, shopping cart, and secure checkout.</p>
              </div>
            </div>
            <div class="card">
              <div class="box">
                ...
                <p>A personal website showcasing skills, projects, and achievements, ideal for professionals and creatives.</p>
              </div>
            </div>
            <div class="card">
              <div class="box">
                ...
                <p>A platform for publishing articles, stories, or updates with categories, comments, and multimedia support.</p>
              </div>
            </div>
            <div class="card">
              <div class="box">
                <img src="messaging app.jpg" alt="message">
                <div class="text">Messaging App</div>
                <p>A real-time chat application allowing users to send and receive text, images, and multimedia messages.</p>
              </div>
            </div>
            <div class="card">
              <div class="box">
                <img src="facebook.jpg" alt="">
                <div class="text">Facebook Clone</div>
                <p>A social networking site mimicking facebook, with features like user profiles, posts, likes, and friend connections.</p>
              </div>
            </div>
        ...
        <div class="max-width">
          ...
          <div class="contact-content">
            <div class="column left">
              ...
              <p>Have a question, idea, or project in mind? I’d love to hear from you. Feel free to reach out, and I’ll get back to you as soon as possible. Let’s work together to bring your ideas to life!
              ...
              <div class="icons">
                ...
                <a href="#">
                  <div class="row">
                    ...
                    <div class="info">
                      ...
                      <div class="sub-title"><a href="#" style="text-decoration: none; color: #333;"> Philip Meliga</a></div>
                    </div>
                  </div>
                </a>
                ...
                <div class="row">
                  ...
                  <div class="info">
                    ...
                    <div class="sub-title"> Jos, Plateau state, Nigeria.</div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="info">
                    ...
                    <div class="sub-title"><a href="mailto: philipmeliga01@gmail.com" style="text-decoration: none; color: #333;"> philipmeliga01@gmail.com</a></div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="info">
                    ...
                    <div class="sub-title">Hausa, English, Igala</div>
                  </div>
                </div>
...
?>
      ...
      <footer>
        <span>
          <a href="#"> Philip Meliga</a> | <span class="far fa-copyright"></span> 2022 All Rights Reserved. Privacy Policy
        </span>
      </footer>
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js'></script>
    <script src="/portfolio/port.js"></script>
  </body>
</html>
